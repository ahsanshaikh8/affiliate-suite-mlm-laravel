    ...
    <div class="col">
        <div class="user-widget-2">
            ...
            @foreach($users as $key => $value)
                <li class="media">
                    <img class="rounded-circle d-flex align-self-center" src="{{ asset('file/'.$value->doc_img) }}" alt="">
                    <div class="media-body">
                        <h5>{{ $value->name }}</h5>
                        <p>{{ $value->email }}</p>
                        <p><span class="badge badge-outline badge-sm badge-info badge-pill">{{ $value->phone_no }}</span>
                        <span class="badge badge-outline badge-sm badge-primary badge-pill">{{ $value->status }}</span><span class="badge badge-outline badge-sm badge-danger badge-pill">{{ $value->address }}</span></p>
